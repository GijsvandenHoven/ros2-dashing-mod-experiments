...
public:
  ...
  : Node("basic_bench_subscriber")
  {
    ...
    subscriber_options.message_tracker_opts.tracker_option = rclcpp::MessageTrackerEnum::NONE;
    subscriber_options.message_tracker_opts.tracker_result_writing_option = rclcpp::MeasurementWriterEnum::NONE;
