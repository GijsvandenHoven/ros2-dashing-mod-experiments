...
#define BASIC_BENCH_JITTER_FOLDER "/home/ruben/june-measurements/ros1/results/basic_bench/activation_jitter/"
#define BASIC_BENCH_BATCH_PER_SIZE 5
#define BASIC_BENCH_PUBLISHER_EXTRA 250
#define BASIC_BENCH_LOOP_RATE 100
